...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        Log.i(LOG_TAG, "extractEarthquakeData()...");
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Earthquake earthquake = new Earthquake(magnitude, location, time, earthquakeUrl);
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("Utils", "Problem retrieving json results.", e);
        } finally {
